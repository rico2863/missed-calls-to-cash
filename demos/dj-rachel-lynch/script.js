/* ============================================================
   MISSED CALLS TO CASH — DJ Rachel Lynch Demo Script
   ============================================================ */
...
const revealTargets = document.querySelectorAll(
  ...
  '.service-card, .about-text, .about-photo-wrap, ' +
  '.callout-card, .section-label, .section-title, .section-intro'
);
...
// ── TRUST BAR DUPLICATE (seamless loop) ──
